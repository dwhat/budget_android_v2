 ...
 */
public class GetLossAmountForCategoriesTask extends AsyncTask<String, Integer, AmountListResponse> {

        private OnTaskCompleted listener = null;
        private Context context;
        private static BudgetAndroidApplication myApp;

        public GetLossAmountForCategoriesTask(Context context, BudgetAndroidApplication myApp, OnTaskCompleted listener)
        {
